...
float calcular_total(float ahorro_seis_meses, float interes_ganado); 
void imprimir_tabla_resultados(float Itm1, float Itm2, float Itm3, float Itm4, float Itm5, float Itm6);
